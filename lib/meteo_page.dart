...
class MeteoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return 
    Consumer<ChangeNotifierData>( builder: (context, value, child) => 
    Container(
        height: height,
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    DataBox(value: value.reelTemperature, icon: Icons.thermostat,unit: "°",size: 30,color: Colors.green,),
                    DataBox(value: value.reelHumidity, icon: Icons.water_drop,unit: "%",size: 30,color: Colors.green,),
                  ],
                ),
              ),
            ),
