...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          DataBox(icon: Icons.thermostat,label: "Température",amount: "${datas['dht_temp']} °C",color: Colors.green,),
          SepareBox,
          DataBox(icon: Icons.water_drop,label: "Humidité Air",amount: "${datas['dht_hum']} %",color: Colors.green,),
          SepareBox,
          DataBox(icon: Icons.grass,label: "Humidité Terre",amount: "${datas['soil_hum']} %",color: Colors.green,),
        ],
      )
    );
  }
